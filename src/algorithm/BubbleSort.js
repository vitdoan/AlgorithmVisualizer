export default function BubbleSort({ handleComparisionAnimation, handleSort, unsortedArray, setColorAtIndex, handleSingleAnimation}) {
	...
	return (
		<a className="bubbleSort sort" onClick={()=>bubbleSort(unsortedArray)}>
			Bubble Sort
		</a>
	);
}
